...
<div class="container">
	<div class="row">
		<?php $__currentLoopData = $add; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		<div class="col-sm-6">		
		  	<div  class="card text-center" style="width: 18rem;">

					
				<img src="<?php echo e($ad->image); ?>" class="card-img-top" class="rounded mx-auto d-block" height="150" width="150">
				<div  class="card-body" >
					<b class="card-title" >Product Name :</b><?php echo e($ad->product_name); ?><br>
					<b class="card-text"> Location:</b><?php echo e($ad->division); ?><br>
					<a href="<?php echo e(route('add.details',['id'=> $ad->adid])); ?>" class="btn btn-primary">Details</a>
				</div>	   							
			</div>
			<br><br>
		</div>
